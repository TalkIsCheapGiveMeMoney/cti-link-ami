 ...
 * {@link ManagerCommunicationException}.
 * 
 * @author srt
 * @version $Id: ManagerCommunicationExceptionMapper.java 938 2007-12-31
 *          03:23:38Z srt $
 */
class ManagerCommunicationExceptionMapper {
	 ...
	 * {@link org.asteriskjava.manager.action.ManagerAction} to the
	 * corresponding {@link ManagerCommunicationException}
	 * .
	 * 
	 * @param actionName
	 *            name of the action that has been tried to send
	 * @param exception
	 *            exception received
	...
	static ManagerCommunicationException mapSendActionException(String actionName, Exception exception) {
		if (exception instanceof IllegalStateException) {
			...
			return new ManagerCommunicationException("Timeout waiting for events from " + actionName + "Action",
					exception);
		} else {
