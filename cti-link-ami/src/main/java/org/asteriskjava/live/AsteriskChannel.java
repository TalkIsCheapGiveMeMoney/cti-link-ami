...
public interface AsteriskChannel extends LiveObject {
	 ...
	 * @return <code>true</code> if this channel was at least once in the given
	 ...
	 * 
	 * @return the reason for hangup or <code>null</code> if the channel has not
	 *         yet been hung up or no hangup cause is available for this type of
	 *         channel.
	 * @since 0.3
	 */
	 ...
	 * 
	 * @return the channel that was dialing this channel or <code>null</code> if
	 *         none was dialing.
	 */
	 ...
	 * 
	 * @return the channel this channel is bridged with, or <code>null</code> if
	 *         this channel is currently not bridged to another channel.
	 */
	 ...
	 *
	 * @return the queue entry associated with this channel if any,
	 *         <code>null</code> otherwise.
	 */
	AsteriskQueueEntry getQueueEntry();

	/**
	 * Return the extension to dial to pickup he channel of the parking if the
	 * channel is currently parked.
	 *
	 ...
	 * {@link org.asteriskjava.manager.event.VarSetEvent VarSetEvents}.
	 * <p>
	 ...
	 *
	 * @return the last DTMF digit received on this channels or
	 *         <code>null</code> if none has yet been received.
	 * @since 1.0.0
	 */
	 ...
	 *
	 * @return the last DTMF digit sent on this channels or <code>null</code> if
	 ...
	 *             if the hangup action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had already been hung up before the hangup
	 *             was sent.
	 * @since 0.3
	 */
	 ...
	 * 
	 * @param seconds
	 *            maximum duration of the call in seconds, 0 for unlimited call
	 *            length.
	 * @throws ManagerCommunicationException
	 *             if the absolute timeout action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had already been hung up before the absolute
	 *             timeout was set.
	 * @since 0.3
	 */
	 ...
	 * @throws ManagerCommunicationException
	 *             if the redirect action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before the redirect was
	 *             sent.
	 * @since 0.3
	 */
	 ...
	 * 
	 * @param variable
	 *            the name of the channel variable to return.
	 * @return the value of the channel variable or <code>null</code> if it is
	 *         not set.
	 * @throws ManagerCommunicationException
	 *             if the get variable action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before the variable was
	 *             requested.
	 * @since 0.3
	 */
	 ...
	 * 
	 * @param variable
	 *            部分参数采取主动去取，而不是用内存中的数据
	 * @return
	 * @throws ManagerCommunicationException
	 * @throws NoSuchChannelException
	 */
	String getNoCacheVariable(String variable) throws ManagerCommunicationException, NoSuchChannelException;

	/**
	 * Sets the value of the given channel variable.
	 * 
	 * @param variable
	 *            the name of the channel variable to set.
	 * @param value
	 *            the value of the channel variable to set.
	 * @throws ManagerCommunicationException
	 *             if the set variable action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before the variable was set.
	 * @since 0.3
	 */
	 ...
	 * @throws ManagerCommunicationException
	 *             if the play DTMF action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before the DTMF digit was
	 *             set.
	 * @throws IllegalArgumentException
	 *             if the digit is <code>null</code>.
	 * @since 0.3
	 */
	 ...
	 *            directory. If <code>null</code> the channel name (with slashed
	 *            replaced by dashes) is used.
	 * @throws ManagerCommunicationException
	 *             if the monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before starting monitoring.
	 * @see #stopMonitoring()
	 * @see #pauseMonitoring()
	 * @since 0.3
	 */
	 ...
	 * <p>
	 * The files are called <i>filename</i>-in.<i>format</i> and <i>filename</i>
	 * -out.<i>format</i>.
	 * 
	 * @param filename
	 *            the basename of the files created in the monitor spool
	 ...
	 *            replaced by dashes) is used.
	 * @param format
	 *            the audio recording format. If <code>null</code> wav is used.
	 * @throws ManagerCommunicationException
	 *             if the monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before starting monitoring.
	 ...
	 * file names without the in/out designator, i.e. <i>filename</i>.
	 * <i>format</i>.<br>
	 * The two leg files are only removed by Asterisk if
	 * <code>MONITOR_EXEC</code> is not set. If you use a custom script and want
	 * to remove them, just let your script do this.<br>
	 ...
	 * </pre>
	 * 
	 * Side note: <tt>2wav2mp3</tt> is a nice script by Dietmar Zlabinger to mix
	 * the two legs to a stero mp3 file, for details see
	 * <a href="http://www.voip-info.org/wiki/view/Monitor+stereo-example">voip-
	 * info.org</a>.
	 * 
	 * @param filename
	 ...
	 *            the audio recording format. If <code>null</code> wav is used.
	 * @param mix
	 *            <code>true</code> to mix input and output data together after
	 *            recording is finished, <code>false</code> to not mix them.
	 * @throws ManagerCommunicationException
	 *             if the monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before starting monitoring.
	 ...
	 *            directory.
	 * @throws ManagerCommunicationException
	 *             if the change monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before changing monitoring.
	 * @throws IllegalArgumentException
	 *             if filename is <code>null</code>.
	 * @see #stopMonitoring()
	 * @see #pauseMonitoring()
	 * @since 0.3
	 */
	 ...
	 * 
	 * @throws ManagerCommunicationException
	 *             if the stop monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before stopping monitoring.
	 ...
	 * 
	 * @throws ManagerCommunicationException
	 *             if the pause monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before temporarily stopping
	 *             monitoring.
	 ...
	 * 
	 * @throws ManagerCommunicationException
	 *             if the unpasue monitor action cannot be sent to Asterisk.
	 * @throws NoSuchChannelException
	 *             if this channel had been hung up before re-enabling
	 *             monitoring.
	 * @see #pauseMonitoring()
	 * @since 0.3
	 */
