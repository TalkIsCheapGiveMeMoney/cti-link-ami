 ...
 * <p>
 * Contract:<br>
 * {@link #onDialing(AsteriskChannel)} is called exactly once iif originate did
 * not fail. It is called immediately after the channel has been created and
 * before it is ringing.<br>
 * In case of a failure {@link #onFailure(LiveException)} is the only method
 * that is called and it is called exactly once.<br>
 * Otherwise one of {@link #onSuccess(AsteriskChannel)}
 * {@link #onBusy(AsteriskChannel)} or {@link #onNoAnswer(AsteriskChannel)} is
 * called exactly once.
 * 
 * @see AsteriskServer#originateToApplicationAsync(String, String, String, long,
 *      OriginateCallback)
 * @see AsteriskServer#originateToApplicationAsync(String, String, String, long,
 *      CallerId, java.util.Map, OriginateCallback)
 * @see AsteriskServer#originateToExtensionAsync(String, String, String, int,
 *      long, OriginateCallback)
 * @see AsteriskServer#originateToExtensionAsync(String, String, String, int,
 *      long, CallerId, java.util.Map, OriginateCallback)
 * @author srt
