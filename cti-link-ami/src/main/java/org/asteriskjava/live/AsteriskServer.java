...
public interface AsteriskServer {
	 ...
	 *             if the channel is not available on the Asterisk server, for
	 *             example because you used "SIP/1310" and 1310 is not a valid
	 *             SIP user, the SIP channel module hasn't been loaded or the
	 *             SIP or IAX peer is not registered currently.
	 * @throws ManagerCommunicationException
	 *             if the originate action cannot be sent to Asterisk
	 */
	 ...
	 * 
	 * @param channel
	 *            channel name to call, for example "SIP/1310".
	 * @param context
	 *            context to connect to
	 * @param exten
	 *            extension to connect to
	 * @param priority
	 *            priority to connect to
	 * @param timeout
	 ...
	 *            <code>null</code>.
	 * @param variables
	 *            channel variables to set, may be <code>null</code>.
	 * @return the generated channel
	 * @throws NoSuchChannelException
	 *             if the channel is not available on the Asterisk server, for
	 *             example because you used "SIP/1310" and 1310 is not a valid
	 ...
	 *            channel name to call, for example "SIP/1310".
	 * @param application
	 *            application to connect to, for example "MeetMe"
	 * @param data
	 ...
	 * @throws ManagerCommunicationException
	 *             if the version cannot be retrieved from Asterisk
	 * @since 0.2
	 */
	 ...
	 *         server
	 * @throws ManagerCommunicationException
	 *             if the voicemailboxes can't be retrieved.
	 * @since 0.3
	 */
	 ...
	 *         CLI command.
	 * @throws ManagerCommunicationException
	 *             if the command can't be executed.
	 ...
	 * @throws ManagerCommunicationException
	 *             if the module can't be checked.
	 */
	 ...
	 *
	 * @throws ManagerCommunicationException
	 *             if the modules cannot be reloaded.
	 * @since 1.0.0
	 */
	 ...
	 *            the listener to add.
	 * @throws ManagerCommunicationException
	 *             if the server is not yet connected and the connection or
