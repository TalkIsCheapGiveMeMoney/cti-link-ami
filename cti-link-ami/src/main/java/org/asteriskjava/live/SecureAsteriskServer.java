...
public class SecureAsteriskServer extends DefaultAsteriskServer {
	/**
	 * Creates a new instance and a new SSL secured {@link ManagerConnection}
	 * with the given connection data.
	 *
	 * @param hostname
	 *            the hostname of the Asterisk server to connect to.
	 * @param port
	 *            the port where Asterisk listens for incoming SSL secured
	 *            Manager API connections, usually 5039.
	 * @param username
