...
public interface AsteriskQueueEntry extends LiveObject {
	 ...
	 * {@link QueueEntryState#JOINED} and set to date the member left when
	 * entering {@link QueueEntryState#LEFT}.
	 *
	 * @return the date this member left the Queue or <code>null</code> if the
	 *         user did not yet leave.
	 */
	Date getDateLeft();
	 ...
	 * <p>
	 * Initially the user is in state
	 * {@link org.asteriskjava.live.QueueEntryState#JOINED}.
	 *
