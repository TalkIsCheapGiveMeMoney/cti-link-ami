...
public interface AsteriskQueueMember extends LiveObject {
	 ...
	 *
	 * @return paused <code>true</code> is this queue member is paused,
	 ...
	 *
	 * @param paused
	 *            <code>true</code> to pause this member, <code>false</code> to
	 *            unpause.
	 * @throws ManagerCommunicationException
	 *             if the QueuePauseAction could not be send to Asterisk.
	 * @throws NoSuchInterfaceException
	 *             if the interface or the queue do not exist.
	 * @since 1.0.0
	 */
	 ...
	 * @throws ManagerCommunicationException
	 *             if the QueuePenaltyAction could not be send to Asterisk.
	 * @throws InvalidPenaltyException
	 *             if Asterisk refused to set the new penalty.
	 * @since 1.0.0
	 */
