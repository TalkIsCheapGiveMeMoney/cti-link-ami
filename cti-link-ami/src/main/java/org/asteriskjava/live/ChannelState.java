...
/**
 * The lifecycle status of an {@link AsteriskChannel}.
 * <br>
...
public enum ChannelState {
	/**
	 * Channel is down and available. This is the initial state of the channel
	 * when it is not yet in use.
	 */
	...
	/**
	 * The channel has been hung up and is not longer available on the Asterisk
	 * server.
	 */
	HUNGUP(-1);
	 ...
	 * @return corresponding ChannelState object or <code>null</code> if none
	 *         matches.
	 */
