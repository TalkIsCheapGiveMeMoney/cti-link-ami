...
public interface MeetMeUser extends LiveObject {
	 ...
	 * 
	 * @return <code>true</code> if this user is currently talking and talker
	 *         detection is supported, <code>false</code> otherwise.
	 */
	boolean isTalking();
	 ...
	 * 
	 * @return <code>true</code> if this user is muted and mute detection is
	 ...
	 * <p>
	 * This property is <code>null</code> as long as the user is in state
	 * {@link MeetMeUserState#JOINED} and set to date the user left when
	 * entering {@link MeetMeUserState#LEFT}.
	 * 
	 * @return the date this user left the MeetMe room or <code>null</code> if
	 *         the user did not yet leave.
	 */
	Date getDateLeft();
