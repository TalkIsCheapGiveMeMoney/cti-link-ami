...
public interface SocketConnectionFacade {
	 ...
	 *            the String to send.
	 * @throws IOException
	 *             if the String cannot be sent, maybe because the connection
	 ...
	 * 
	 * @throws IOException
	 *             if the connection cannot be flushed.
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if the socket connection cannot be closed.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the socket successfuly connected to a server
	 */
	boolean isConnected();
