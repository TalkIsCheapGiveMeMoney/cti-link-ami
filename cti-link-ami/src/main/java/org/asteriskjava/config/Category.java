...
public class Category extends ConfigElement {
	...
	/**
	 * The last object in the list will get assigned any trailing comments when
	 * EOF is hit.
	 */
	 ...
	 *
	 * @return <code>true</code> if this category is a template,
	 ...
	 *
	 * @return a list of categories this category inherits from, never
	 *         <code>null</code>.
	 */
