...
/**
 * Corresponds to a CoreStatusAction and contains the current status summary of
 * the Asterisk server.
 *
 * @author srt
...
public class CoreStatusResponse extends ManagerResponse {
	...
	/**
	 * Returns the date the server (core module) was last reloaded. The format
	 * is Y-%m-%d.
	 * <p>
	 ...
	 * <p>
	 * If either the date or time property is <code>null</code> (e.g. on
	 * Asterisk prior to 1.6.3) this method returns <code>null</code>.
	 *
	 * @return the and time the server (core module) was last reloaded or
	 *         <code>null</code> if not available.
	 * @see #getCoreReloadDate()
	 * @see #getCoreReloadTime()
	 * @see #getCoreReloadDateTimeAsDate(TimeZone)
	 */
	 ...
	 *
	 * @param tz
	 *            the time zone of the Asterisk server, <code>null</code> to use
	 *            the default time zone.
	 * @return the date the server (core module) was last reloaded or
	 *         <code>null</code> if not available.
	 * @see #getCoreReloadDate()
	 * @see #getCoreReloadTime()
	 */
	 ...
	 * Asterisk prior to 1.6.3) this method returns <code>null</code>.
	 *
	 * @return the date the server was started or <code>null</code> if not
	 *         available.
	 * @see #getCoreStartupDate()
	 * @see #getCoreStartupTime()
	 * @see #getCoreStartupDateTimeAsDate(TimeZone)
	 */
