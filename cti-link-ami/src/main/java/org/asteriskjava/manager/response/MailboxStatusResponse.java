...
/**
 * A MailboxStatusResponse is sent in response to a MailboxStatusAction and
 * indicates if a set of mailboxes contains waiting messages.
 * 
...
public class MailboxStatusResponse extends ManagerResponse {
	...
	/**
	 * Indicates if there are new messages waiting in the given set of
	 * mailboxes.
	 */
	...
	/**
	 * Returns Boolean.TRUE if at least one of the given mailboxes contains new
	 * messages; Boolean.FALSE otherwise.
	 */
	...
	/**
	 * Set to Boolean.TRUE if at least one of the mailboxes contains new
	 * messages; Boolean.FALSE otherwise.
	 */
