...
/**
 * Corresponds to a CoreSettingsAction and contains the current settings summary
...
public class CoreSettingsResponse extends ManagerResponse {
	...
	/**
	 * Returns the version of the Asterisk Manager Interface (AMI). For Asterisk
	 * 1.6 this is "1.1".
	 *
	 ...
	 *
	 * @return <code>true</code> if the realtime subsystem is enabled,
	 ...
	 *
	 * @return <code>true</code> if the CDR subsystem is enabled,
	 *         <code>false</code> otherwise.
	 */
	 ...
	 *
	 * @return <code>true</code> if the HTTP subsystem is enabled,
	 *         <code>false</code> otherwise.
	 */
