...
interface ActionBuilder {
	...
	/**
	 * Builds a String suitable to be sent to Asterisk based on the given action
	 * object.
	 * <p>
	 * Asterisk actions consist of an unordered set of key value pairs
	 * corresponding to the attributes of the ManagerActions. Key and value are
	 * separated by a colon (":"), key value pairs by a CR/NL ("\r\n"). An
	 * action is terminated by an empty line ("\r\n\r\n").
	 * 
	 * @param action
	 *            the action to transform
	 * @return a String representing the given action in an asterisk compatible
	 *         format
	 */
