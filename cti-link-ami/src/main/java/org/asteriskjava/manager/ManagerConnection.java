...
public interface ManagerConnection {
	 ...
	 *            the class representing the user event to register.
	 * @throws IllegalArgumentException
	 *             if userEventClass is not a valid event class.
	 ...
	 *            the read timeout value to be used in milliseconds.
	 ...
	 * 
	 * @throws IllegalStateException
	 *             if not in state CONNECTED or RECONNECTING.
	 ...
	 *             if the network connection is disrupted.
	 * @throws TimeoutException
	 *             if no response is received within the default timeout period.
	 * @throws IllegalArgumentException
	 *             if the action is <code>null</code>.
	 * @throws IllegalStateException
	 *             if you are not connected to an Asterisk server.
	 ...
	 *             if the network connection is disrupted.
	 * @throws TimeoutException
	 *             if no response is received within the given timeout period.
	 * @throws IllegalArgumentException
	 *             if the action is <code>null</code>.
	 * @throws IllegalStateException
	 *             if you are not connected to an Asterisk server.
	 ...
	 *            the action to send to the Asterisk server
	 * @param callback
	 *            the callback handler to call when the response is received or
	 *            <code>null</code> if you are not interested in the response
	 * @throws IOException
	 *             if the network connection is disrupted.
	 * @throws IllegalArgumentException
	 *             if the action is <code>null</code>.
	 * @throws IllegalStateException
	 *             if you are not connected to the Asterisk server.
	 */
	 ...
	 *             if no response or not all response events are received within
	 *             the given timeout period.
	 * @throws IllegalArgumentException
	 *             if the action is <code>null</code>, the
	 ...
	 * @since 0.2
	 */
	ResponseEvents sendEventGeneratingAction(EventGeneratingAction action) throws IOException, EventTimeoutException, IllegalArgumentException, IllegalStateException;
	 ...
	 *            the action to send to the Asterisk server
	 * @param timeout
	 *            milliseconds to wait for the response and the action complete
	 ...
	 * 
	 * @param eventListener
	 *            the listener to call whenever a manager event is received
