 ...
 * {@link ManagerConnection}s.
 * <p>
 * It creates new connections in state
 * {@link ManagerConnectionState#INITIAL}. Before you
 * can start using such a connection (i.e. sending
 * {@link org.asteriskjava.manager.action.ManagerAction}s you must
 * {@link ManagerConnection#login()} to change its
 * state to {@link ManagerConnectionState#CONNECTED}.
 * <p>
 * Example:
 * 
 * <pre>
...
public class ManagerConnectionFactory {
	 ...
	 * {@link ManagerConnectionState#CONNECTED}.
	 * 
