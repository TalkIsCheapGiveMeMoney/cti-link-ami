...
public class MeetMeTalkingEvent extends AbstractMeetMeEvent {
	 ...
	 * <p>
	 * Until Asterisk 1.2 Asterisk used different events to indicate start and
	 * stop: This MeetMeTalkingEvent when the user started talking and the
	 * {@link MeetMeStopTalkingEvent} when he stopped. With Asterisk 1.2 only
	 * this MeetMeTalkingEvent is used with the status property indicating start
	 * and stop. For backwards compatibility this property defaults to
