...
public class TransferEvent extends ManagerEvent {
	...
	/**
	 * Returns whether this is an attended or a blind transfer. Possible values
	 * are "Attended" and "Blind".
	 *
	 * @return "Attended" if this an attended transfer, "Blind" if it is a blind
	 *         transfer.
	 ...
	 *
	 * @return <code>true</code> if this is an attended transfer,
	 ...
	 *
	 * @return <code>true</code> if this is an blind transfer,
	 *         <code>false</code> if not.
	 */
	...
	/**
	 * Returns the target extension the call is transfered to. This is only
	 * available for blind transfers. If the call is transfered to a parking
	 * extension, the parking extension is returned.
	 *
	 * @return the target extension the call is transfered to or
	 *         <code>null</code> for attended transfers.
	 */
	 ...
	 * This is only available for blind transfers. If the call is transfered to
	 * a parking extension <code>null</code> is returned.
	 *
	 * @return the target context the call is transfered to or <code>null</code>
	 *         for attended transfers and transfers to a parking extension.
	 */
	 ...
	 *
	 * @return Boolean.TRUE if this is a transfer to a parking extension,
	 ...
	 *
	 * @return <code>true</code> if this is a transfer to a parking extension,
