...
/**
 * A CoreShowChannelsCompleteEvent is triggered after the state of all channels
 * has been reported in response to a CoreShowChannelsAction.
 *
...
public class CoreShowChannelsCompleteEvent extends ResponseEvent {
	 ...
	 *
	 * @param items
	 *            the number of channels reported.
	 */
