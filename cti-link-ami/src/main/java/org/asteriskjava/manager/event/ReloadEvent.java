...
/**
 * A ReloadEvent is triggerd when the <code>reload</code> console command is
 * executed or the Asterisk server is started.
 * <p>
...
public class ReloadEvent extends ManagerEvent {
	 ...
	 * Available since Asterisk 1.6.
	 *
	 * @return "Enabled" if the module is endabled, "Disabled" if it is
	 *         disabled.
	 * @since 1.0.0
	 * @see #STATUS_ENABLED
	 * @see #STATUS_DISABLED
	 ...
	 *
	 * @param status
	 *            "Enabled" if the module is endabled, "Disabled" if it is
	 *            disabled.
	 * @since 1.0.0
	 */
	 ...
	 * Available since Asterisk 1.6.
	 *
	 * @return <code>true</code> the module is now enabled, <code>false</code>
	 *         if it is disabled. For Asterisk versions up to 1.4 that do not
	 *         support the "Status" property <code>false</code> is returned.
	 * @see #getStatus()
	 * @since 1.0.0
	 */
	 ...
	 * Available since Asterisk 1.6.
	 *
	 * @return <code>true</code> the module is now disabled, <code>false</code>
	 *         if it is enabled. For Asterisk versions up to 1.4 that do not
	 *         support the "Status" property <code>false</code> is returned.
	 * @see #getStatus()
	 * @since 1.0.0
	 */
