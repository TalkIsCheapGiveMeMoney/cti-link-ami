...
/**
 * A CdrEvent is triggered when a call detail record is generated, usually at
 * the end of a call.
 * <p>
 * To enable CdrEvents you have to add <code>enabled = yes</code> to the general
 * section in <code>cdr_manager.conf</code>.
 * <p>
...
public class CdrEvent extends ManagerEvent {
	 ...
	 * 
	 * @return the name of the destination channel or <code>null</code> if not
	 *         available.
	 */
	 ...
	 * 
	 * @return the last application's data or <code>null</code> if not
	 *         avaialble.
	 */
	 ...
	 * 
	 * @return A string of the format "%Y-%m-%d %T" (strftime(3)) representing
	 *         the date/time the call has started, for example
	 *         "2006-05-19 11:54:48".
	 */
	 ...
	 * 
	 * @param startTime
	 *            the date/time when the call has started.
	 */
	 ...
	 * 
	 * @return A string of the format "%Y-%m-%d %T" (strftime(3)) representing
	 *         the date/time the call was answered, for example
	 *         "2006-05-19 11:55:01"
	 */
	 ...
	 * 
	 * @param answerTime
	 *            the date/time when the call was answered.
	 */
	 ...
	 * 
	 * @return A string of the format "%Y-%m-%d %T" (strftime(3)) representing
	 *         the date/time the call has ended, for example
	 *         "2006-05-19 11:58:21"
	 */
	 ...
	 * 
	 * @param endTime
	 *            the date/time when the call has ended.
	 */
	 ...
	 * 
	 * @param amaFlags
	 *            the AMA (Automated Message Accounting) flags.
	 */
	 ...
	 * <code>Set(CDR(userfield)=Value)</code>.
	 * <p>
