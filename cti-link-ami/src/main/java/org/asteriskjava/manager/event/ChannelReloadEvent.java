...
public class ChannelReloadEvent extends ManagerEvent {
	 ...
	 *
	 * @see ChannelReloadEvent#REASON_CLI_RELOAD
	 * @see ChannelReloadEvent#REASON_LOAD
	 * @see ChannelReloadEvent#REASON_RELOAD
	 * @see ChannelReloadEvent#REASON_MANAGER_RELOAD
	 */
	...
	/**
	 * Returns the type of channel that was reloaded. For
	...
	/**
	 * @param peerCount
	 *            the number of peers defined during the configuration of this
	 *            channel (e.g. sip peer definitions)
	 */
	...
	/**
	 * @param registryCount
	 *            the number of registrations with other channels (e.g.
	 *            registrations with other sip proxies)
	 */
	...
	/**
	 * Returns the reason that this channel was reloaded as received from
	...
	/**
	 * Sets the reason that this channel was reloaded, for example
	 * "CLIRELOAD (Channel module reload by CLI command)".
	 *
	 * @param reloadReason
	 *            the reason that this channel was reloaded
	 */
	...
	/**
	 * Returns the reason that this channel was reloaded as a human readable
	 * descriptive string, for example "Channel module reload by CLI command".
	 *
	...
	/**
	 * @param userCount
	 *            the number of users defined during the configuration of this
	 *            channel (e.g. sip user definitions)
	 */
