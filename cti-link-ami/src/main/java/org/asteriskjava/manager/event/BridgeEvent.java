...
/**
 * A BridgeEvent is triggered when a link between two voice channels is
 * established ("Link") or discontinued ("Unlink").
 * <p>
 * As of Asterisk 1.6 the Bridge event is reported directly by Asterisk.
 * Asterisk versions up to 1.4 report individual events:
 * {@link org.asteriskjava.manager.event.LinkEvent} and
 * {@link org.asteriskjava.manager.event.UnlinkEvent}.For maximum compatibily do
 * not use the Link and Unlink events in your code. Just use the Bridge event
 * and check for {@link #isLink()} and {@link #isUnlink()}.
 * <p/>
...
public class BridgeEvent extends ManagerEvent {
	 ...
	 *
	 * @return "Link" if the two channels have been linked, "Unlink" if they
	 *         have been unlinked.
	 ...
	 *
	 * @param bridgeState
	 *            "Link" if the two channels have been linked, "Unlink" if they
	 *            have been unlinked.
	 * @since 1.0.0
	 */
