...
/**
 * A ChannelUpdateEvent provides additional channel type specific information
 * like the SIP call id or IAX2 call numbers about a channel.
 * <p>
 * Available since Asterisk 1.6.
 * <p>
 * It is implemented in <code>channels/chan_sip.c</code>,
 * <code>channels/chan_iax2.c</code> and <code>channels/chan_gtalk.c</code>
 *
 * @author srt
...
public class ChannelUpdateEvent extends ManagerEvent {
	...
	/**
	 * Returns the type of channel, that is "IAX2" for an IAX2 channel or "SIP"
	 * for a SIP channel.<br>
