...
/**
 * A BridgeExecEvent is triggered when two channels are bridged through a
 * feature code or bridging the channels fails.
 * <p>
 * It is implemented in <code>main/features.c</code>
 * <p>
