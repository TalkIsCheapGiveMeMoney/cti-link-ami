...
/**
 * A VoicemailUserEntryCompleteEvent is triggered in response to a
 * VoicemailUsersListAction and contains the details about a voicemail user.
 * <p>
...
public class VoicemailUserEntryEvent extends ResponseEvent {
	...
	/**
	 * Returns the mailbox id. The mailbox is unique within the voicemail
	 * context.
	 *
	...
	/**
	 * Returns the full name of the voicemail user that is used for the
	...
	/**
	 * Returns the email adress of pager of the voicemail user. This email will
	...
	/**
	 * Returns the email address used for the "from" header when sending
	 * notification emails.
	 *
	 * @return the email address used for the "from" header when sending
	 *         notification emails.
	 */
	...
	/**
	 * Sets the email address used for the "from" header when sending
	 * notification emails.
	 *
	 * @param serverEmail
	 *            the email address used for the "from" header when sending
	 *            notification emails.
	 */
	...
	/**
	 * Returns the custom mail command used to send notifications to the
	 * voicemail user.
	 *
	 * @return the custom mail command used to send notifications to the
	 *         voicemail user.
	 */
	...
	/**
	 * Sets the custom mail command used to send notifications to the voicemail
	 * user.
	 *
	 * @param mailCommand
	 *            the custom mail command used to send notifications to the
	 *            voicemail user.
	 */
	...
	/**
	 * Returns the dialplan context used by the "return phone call" feature in
	 * the advanced voicemail features menu.
	 *
	 * @return the dialplan context used by the "return phone call" feature in
	 *         the advanced voicemail features menu.
	 */
	...
	/**
	 * Sets the dialplan context used by the "return phone call" feature in the
	 * advanced voicemail features menu.
	 *
	 * @param callback
	 *            the dialplan context used by the "return phone call" feature
	 *            in the advanced voicemail features menu.
	 */
	...
	/**
	 * Returns the dialplan context used by the "place an outgoing call" feature
	 * in the advanced voicemail features menu.
	 *
	 * @return the dialplan context used by the "place an outgoing call" feature
	 *         in the advanced voicemail features menu.
	 */
	...
	/**
	 * Sets the dialplan context used by the "place an outgoing call" feature in
	 * the advanced voicemail features menu.
	 *
	 * @param dialout
	 *            the dialplan context used by the "place an outgoing call"
	 *            feature in the advanced voicemail features menu.
	 */
	...
	/**
	 * Returns the dialplan context the user is dropped into after he has
	 * pressed * or 0 to exit voicemail.
	 *
	 * @return the dialplan context the user is dropped into after he has
	 *         pressed * or 0 to exit voicemail.
	 */
	...
	/**
	 * Sets the dialplan context the user is dropped into after he has pressed *
	 * or 0 to exit voicemail.
	 *
	 * @param exitContext
	 *            the dialplan context the user is dropped into after he has
	 *            pressed * or 0 to exit voicemail.
	 */
	...
	/**
	 * Returns whether Asterisk copies a voicemail message to an audio file and
	 * sends it to the user as an attachment in an eemail voicemail notification
	 * message.
	 *
	 * @return Booelan.TRUE if message will be attached, Boolean.FALSE if not,
	...
	/**
	 * Sets whether Asterisk copies a voicemail message to an audio file and
	 * sends it to the user as an attachment in an eemail voicemail notification
	 * message.
	 *
	 * @param attachMessage
	 *            Booelan.TRUE if message will be attached, Boolean.FALSE if
	 *            not, <code>null</code> if unset.
	 */
	...
	/**
	 * Returns whether messages will be deleted from the voicemailbox (after
	 * having been emailed).
	 *
	 * @return Booelan.TRUE if messages will be deleted from the voicemailbox,
	 *         Boolean.FALSE if not, <code>null</code> if unset.
	 */
	...
	/**
	 * Sets whether messages will be deleted from the voicemailbox (after having
	 * been emailed).
	 *
	 * @param deleteMessage
	 *            Booelan.TRUE if messages will be deleted from the
	 *            voicemailbox, Boolean.FALSE if not.
	 */
	...
	/**
	 * Returns the number of old ("read" or listened to) messages for this
	 * voicemail user.
	 * <p>
