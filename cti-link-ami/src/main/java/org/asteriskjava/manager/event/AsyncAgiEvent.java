 ...
 * <ul>
 * <li>Start: A channel has started the AGI("agi:async") application and is
 * awaiting Async AGI commands.</li>
 * <li>Exec: Execution of an AGI command initiated through
 * {@link org.asteriskjava.manager.action.AgiAction} has finished.</li>
...
public class AsyncAgiEvent extends ResponseEvent {
	 ...
	 * {@link org.asteriskjava.manager.action.AgiAction}.
	 * <p>
	...
	/**
	 * Returns the raw result of a command execution in response to the
	 * corresponding {@link org.asteriskjava.manager.action.AgiAction}.
	 * <p>
	 * This property is only available for the "Exec" sub event.
	 * <p>
	 ...
	 * line is URL encoded and contains a key and a value. The environment ends
	 ...
	 *
	 * @return The decoded AGI environment or an empty list if the environment
	 *         is not available (that is if {@link #getEnv()} returns
	 *         <code>null</code>).
	 * @see #getEnv()
	 */
	 ...
	 *
	 * @return <code>true</code> if this is an "Exec" sub event,
	 *         <code>false</code> otherwise.
	 */
