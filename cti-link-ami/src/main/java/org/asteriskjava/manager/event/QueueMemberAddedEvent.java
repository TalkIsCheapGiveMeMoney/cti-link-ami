...
public class QueueMemberAddedEvent extends AbstractQueueMemberEvent {
	 ...
	 * 
	 * @param lastCall
	 *            the time (in seconds since 01/01/1970) the last successful
	 *            call answered by the added member was hungup.
	 */
	 ...
	 * 
	 * @param paused
	 *            <code>Boolean.TRUE</code> if this member has been paused or
	 *            <code>Boolean.FALSE</code> if not.
	 */
