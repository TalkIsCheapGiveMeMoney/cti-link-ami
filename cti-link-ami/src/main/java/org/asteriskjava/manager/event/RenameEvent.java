...
public class RenameEvent extends ManagerEvent {
	 ...
	 * <p>
	 * The "Oldchannel" property has been renamed to "Channel" as of Asterisk
	 * 1.6.
	 *
	 * @param channel
	 ...
	 * Sets the old name of the channel.
	 * <p>
	 * The "Oldchannel" property is used by Asterisk up to 1.4 and has been
	 * renamed to "Channel" as of Asterisk 1.6.
	 * 
	 * @param oldname
	 *            the old name of the channel.
	 */
