...
/**
 * A ShutdownEvent is triggered when the asterisk server is shut down or
 * restarted.
 * <p>
...
public class ShutdownEvent extends ManagerEvent {
	...
	/**
	 * Returns the kind of shutdown or restart. Possible values are "Uncleanly"
	 * and "Cleanly". A shutdown is considered unclean if there are any active
	 * channels when the system is shut down.
	 */
	...
	/**
	 * Returns <code>true</code> if the server has been restarted;
