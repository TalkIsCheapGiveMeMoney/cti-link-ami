...
public class RegistryEvent extends ManagerEvent {
	...
	/**
	 * Returns the type of channel that is registered, that is "IAX2" for an
	 * IAX2 channel or "SIP" for a SIP channel.
	 *
	 ...
	 *
	 * @return the cause of a rejected registration or <code>null</code> if the
	 *         cause is unknown.
	 * @since 0.2
	 */
