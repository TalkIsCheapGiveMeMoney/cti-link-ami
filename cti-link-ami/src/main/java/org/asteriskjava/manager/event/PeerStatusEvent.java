...
public class PeerStatusEvent extends ManagerEvent {
	 ...
	 * <p>
	 * The peer name includes the channel type prefix. So if you receive a
	 * PeerStatusEvent for a SIP peer defined as "john" in <code>sip.conf</code>
	 * this method returns "SIP/john".
	 * <p/>
	 * Peer names for IAX clients start with "IAX2/", peer names for SIP clients
	 * start with "SIP/".
	 *
	 ...
	 * <p>
	 * For SIP peers this is set if the status equals "Unregistered" and the
	 * peer was unregistered due to an expiration. In that case the cause is set
	 * to "Expired".
	 *
	...
	/**
	 * Returns the ping time of the client if status equals "Reachable" or
	 * "Lagged"; if the status equals "Unreachable" it returns how long the last
	 * response took (in ms) for IAX peers or -1 for SIP peers.
	 */
	...
	/**
	 * Returns the IP address of the peer that registered. Only available for
	 * SIP channels.
	 * <p>
	 * Available since Asterisk 1.6.
	 *
	 * @return the IP address of the peer that registered or <code>null</code>
	 *         if not available.
	 * @since 1.0.0
	 */
	...
	/**
	 * Returns the port of the peer that registered. Only available for SIP
	 * channels.
	 * <p>
	 * Available since Asterisk 1.6.
	 *
	 * @return the port of the peer that registered or <code>null</code> if not
	 *         available.
	 * @since 1.0.0
	 */
