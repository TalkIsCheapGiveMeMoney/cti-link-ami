...
/**
 * A RegistryEntry is triggered in response to a SipShowRegistryAction and
 * contains information about a SIP registration.
 * <p>
...
public class RegistryEntryEvent extends ResponseEvent {
	...
	*/
	...
	/**
	 * Sets the epoch (unix Timestamp) of the last registration. Will be casted
	 * to Long.
	 *
	 * @param registrationTime
	 *            the epoch of the last registration.
	 */
