...
public class QueueSummaryEvent extends ResponseEvent {
	...
	/**
	 * Returns the current avarage hold time for this queue based on an
	 * exponential average.
	 *
	...
	/**
	 * Sets the current avarage hold time for this queue based on an exponential
	 * average.
	 *
	 * @param holdTime
	...
	/**
	 * Returns the longest hold time of the a queue entry currently in the
	 * queue.
	 *
	 * @return the longest hold time of the a queue entry currently in the
	 *         queue.
	 * @since 1.0.0
	 */
	 ...
	 *
	 * @param longestHoldTime
	 *            the longest hold time of the a queue entry currently in the
	 *            queue.
	 * @since 1.0.0
	 */
