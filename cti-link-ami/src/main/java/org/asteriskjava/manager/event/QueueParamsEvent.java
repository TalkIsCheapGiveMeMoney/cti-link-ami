 ...
 * contains the parameters of a queue.
 * <p>
...
public class QueueParamsEvent extends ResponseEvent {
	...
	/**
	 * Returns the maximum number of people waiting in the queue or 0 for
	 * unlimited.
	 * <p>
	 * This corresponds to the <code>maxlen</code> setting in
	 * <code>queues.conf</code>.
	 *
	 * @return the maximum number of people waiting in the queue or 0 for
	 *         unlimited.
	 */
	 ...
	 *
	 * @param max
	 *            the maximum number of people waiting in the queue or 0 for
	 *            unlimited.
	 */
	...
	/**
	 * Returns the current avarage talk time for this queue based on an
	 * exponential average.
	 *
	...
	/**
	 * Sets the current avarage talk time for this queue based on an exponential
	 * average.
	 *
	 * @param talkTime
	...
	/**
	 * Returns the ratio of calls answered within the specified service level
	 * per total completed calls (in percent).
	 *
	 * @return the ratio of calls answered within the specified service level
	 *         per total completed calls (in percent).
	 */
	...
	/**
	 * Sets the ratio of calls answered within the specified service level per
	 * total completed calls.
	 *
	 * @param serviceLevelPerf
	 *            the ratio of calls answered within the specified service level
	 *            per total completed calls (in percent).
	 */
	 ...
	 *
	 * @return the weight of this queue or <code>null</code> if not supported by
