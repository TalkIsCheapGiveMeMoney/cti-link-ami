...
/**
 * A ShowDialplanCompleteEvent is triggered for each priority in the dialplan in
 * response to a ShowDialplanAction.
 * <p>
...
public class ListDialplanEvent extends ResponseEvent {
	 ...
	 * 
	 * @return <code>true</code> if this is a hint, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Returns the parameters of the application configured to handle this
	 * priority.
	 *
	 * @return the parameters of the application configured to handle this
	 *         priority or <code>null</code> if none.
	 */
	 ...
	 * <p>
	 * Typical values are "features" for the parkedcalls context, "pbx_config"
	 * for priorities defined in <code>extensions.conf</code> or "app_dial" for
	 * the app_dial_gosub_virtual_context context.
	 *
