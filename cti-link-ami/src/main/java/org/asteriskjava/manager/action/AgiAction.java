 ...
 * <p>
 * It will append the application to the specified channel's queue. If the
 * channel is not inside Async AGI application it will return an error.
 * <p>
...
public class AgiAction extends AbstractManagerAction implements EventGeneratingAction {
	 ...
	 * <p>
	 * This value will be sent back in the CommandID header of AsyncAGI exec
	 * event notifications.
	 *
	 * @param commandId
	 *            the command id to track execution progress.
