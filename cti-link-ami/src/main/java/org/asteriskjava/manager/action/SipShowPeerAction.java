 ...
 * to retrieve the properties. Consider using
 * {@link org.asteriskjava.manager.action.SipPeersAction} instead.
 * <p>
...
public class SipShowPeerAction extends AbstractManagerAction {
	 ...
	 * 
	 * @param peer
	 *            the name of the SIP peer to retrieve details for.
	 * @since 0.2
	 */
	 ...
	 * 
	 * @param peer
	 *            the name of the peer to retrieve without the channel type
	 *            prefix.
	 */
