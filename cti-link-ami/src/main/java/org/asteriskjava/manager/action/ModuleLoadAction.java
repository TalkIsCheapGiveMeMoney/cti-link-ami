...
public class ModuleLoadAction extends AbstractManagerAction {
	 ...
	 *
	 * @param module
	 *            the name of the module including the ".so" extension or
	 *            subsystem to perform the operation on or <code>null</code>
	 *            combined with loadType "reload" to reload all modules.
	 * @param loadType
	 *            the operation to perform ("load", "unload" or "reload").
	 */
	...
	/**
	 * Sets the name of the module including the ".so" extension or subsystem
	 * ("cdr", "enum", "dnsmgr", "extconfig", "manager", "rtp" or "http") to
