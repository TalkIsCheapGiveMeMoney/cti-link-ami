...
public class QueueAddAction extends AbstractManagerAction {
	 ...
	 * @param iface
	 *            Sets the interface to add. To add a specific channel just use
	 *            the channel name, e.g. "SIP/1234".
	 * @since 0.2
	 */
	 ...
	 *            the channel name, e.g. "SIP/1234".
	 * @param penalty
	 *            the penalty for this member. The penalty must be a positive
	 *            integer or 0 for no penalty. When calls are distributed
	...
	/**
	 * Sets the name of the channel (Technology/Location) to dial to reach this
	 * member.
	 * <p>
	 * This property is mandatory.
	 *
	 * @param iface
	 *            the name of the channel to dial to reach this member, e.g.
	 *            "SIP/1234".
	 */
	 ...
	 * <p>
	 * The penalty must be a positive integer or 0 for no penalty. If it is not
	 * set 0 is assumed.
	 * <p>
	...
	/**
	 * Sets the name of the channel (Technology/Location) from which to read
	 * devicestate changes.
	 * <p>
	 * Available since Asterisk 1.6
	 *
	 * @param stateInterface
	 *            the name of the channel from which to read devicestate
	 *            changes.
	 * @since 1.0.0
	 */
