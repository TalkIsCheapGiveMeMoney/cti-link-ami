...
/**
 * The BridgeAction bridges two channels that are currently active on the
 * system.
 * <p>
 * It is definied in <code>res/res_features.c</code>.
 * <p>
...
public class BridgeAction extends AbstractManagerAction {
	 ...
	 *            the name of the channel to bridge to channel1.
	 * @param tone
	 *            <code>true</code> to play a courtesy tone to channel2,
	 ...
	 *
	 * @return <code>true</code> to play a courtesy tone to channel2,
	 *         <code>false</code> or <code>null</code> (if not set) otherwise.
	 */
