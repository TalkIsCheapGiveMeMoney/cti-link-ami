...
/**
 * The QueueLogAction adds a custom log entry to the <code>queue_log</code>.
 * <p>
...
public class QueueLogAction extends AbstractManagerAction {
	...
	/**
	 * Creates a new QueueLogAction with the mandatory properties queue and
	 * event.
	 *
	 * @param queue
	 ...
	 * @param iface
	 *            the interface of the member to log the event for, may be
	 *            <code>null</code>.
	 * @param uniqueId
	 *            the unique id of the channel to log the event for, may be
	 *            <code>null</code>.
	 */
