...
/**
 * The ExtensionStateAction queries the state of an extension in a given
 * context. If the extension has a hint, will use devicestate to check the
...
public class ExtensionStateAction extends AbstractManagerAction {
	...
	/**
	 * Creates a new ExtensionStateAction that queries the state of the given
	 * extension in the given context.
	 *
	 * @param exten
