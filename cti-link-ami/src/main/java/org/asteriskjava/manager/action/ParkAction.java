 ...
 * <p>
 * Defined in <code>res/res_features.c</code>
 * <p>
...
public class ParkAction extends AbstractManagerAction {
	 ...
	 * @param channel2
	 *            name of the channel to announce park info to and return to on
	 *            timeout.
	 */
	 ...
	 * @param channel2
	 *            the name of the channel to announce park info to and return to
	 *            on timeout.
	 * @param timeout
