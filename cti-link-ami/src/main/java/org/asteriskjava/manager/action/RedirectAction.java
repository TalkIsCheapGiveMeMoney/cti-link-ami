...
public class RedirectAction extends AbstractManagerAction {
	 ...
	 * 
	 * @param channel
	 *            the name of the first channel to redirect
	 * @param extraChannel
	 *            the name of the second channel to redirect
	 * @param context
	 *            the destination context
	 * @param exten
	 *            the destination extension
	 ...
	 *            the name of the second channel to redirect
	 * @param context
	 *            the destination context for the first channel
	 * @param exten
	 *            the destination extension for the first channel
	 * @param priority
	 *            the destination priority for the first channel
	 * @param extraContext
	 *            the destination context for the second channel
	 * @param extraExten
	 *            the destination extension for the second channel
	 * @param extraPriority
	 *            the destination priority for the second channel
	 * @since 0.3
	 */
