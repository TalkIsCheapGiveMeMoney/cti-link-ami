 ...
 * via multiple variables. At least one variable pair must be specified.
 * <p>
...
public class SipNotifyAction extends AbstractManagerAction {
	 ...
	 *
	 * @param channel
	 *            the peer to send the notify to either "SIP/peer" or just
	 *            "peer".
	 */
	 ...
	 *
	 * @param channel
	 *            peer to receive the notify to either "SIP/peer" or just
	 *            "peer".
	 */
