 ...
 * <p>
 * For each user that is found a VoicemailUserEntryEvent event is sent by
 * Asterisk containing the details. When all peers have been reported a
 * VoicemailUserEntryCompleteEvent is sent.
 * <p>
