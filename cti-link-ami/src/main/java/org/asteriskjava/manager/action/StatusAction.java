...
/**
 * The StatusAction requests the state of all active channels. Alternativly (as
 * of Asterisk 1.6) you can also pass a channel name to only retrive the status
...
public class StatusAction extends AbstractManagerAction implements EventGeneratingAction {
	...
	/**
	 * Creates a new StatusAction that retrieves the status of the given
	 * channel.
	 * <p>
	 ...
	 *
	 * @param channel
	 *            the name of the channel or <code>null</code> for all channels.
	 * @since 1.0.0
	 */
	...
	/**
	 * Sets the names of the channel variables to return for each reported
	 * channel.
	 * <p>
	 * Available since Asterisk 1.6.
	 *
	 * @param variables
	 *            comma separated list of variables to return for each reported
	 *            channel.
	 ...
	 *
	 * @param variables
	 *            list of variables to return for each reported channel.
	 * @see org.asteriskjava.manager.event.StatusEvent#getVariables()
	 * @since 1.0.0
	 */
