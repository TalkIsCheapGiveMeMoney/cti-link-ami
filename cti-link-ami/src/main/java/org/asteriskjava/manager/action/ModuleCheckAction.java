...
/**
 * The ModuleLoadAction checks if an Asterisk module is loaded and reports its
 * version.
 * <p>
 * The ModuleLoadAction returns a
 * {@link org.asteriskjava.manager.response.ModuleCheckResponse} with the
 * version of the module if the module is loaded and a
 * {@link org.asteriskjava.manager.response.ManagerError} if the module is not
 * loaded.
 * <p>
...
public class ModuleCheckAction extends AbstractManagerAction {
	 ...
	 *
	 * @param module
	 *            the name of the module (including or not including the ".so"
	 *            extension).
	 */
	...
	/**
	 * Sets the name of the module (including or not including the ".so"
	 * extension) to check.
	 *
	 * @param module
	 *            the name of the module (including or not including the ".so"
