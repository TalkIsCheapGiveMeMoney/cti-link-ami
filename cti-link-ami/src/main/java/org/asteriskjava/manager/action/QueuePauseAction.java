...
public class QueuePauseAction extends AbstractManagerAction {
	 ...
	 */
	public QueuePauseAction(String iface, String reason) {
		this.iface = iface;
	 ...
	 */
	public QueuePauseAction(String iface, String queue, String reason) {
		this.iface = iface;
		this.queue = queue;
		this.paused = Boolean.TRUE;
		this.reason = reason;
	 ...
	 *            the interface of the member to make unavailable
	 * @param paused
	 *            Boolean.TRUE to make the member unavailbale, Boolean.FALSE to
	 *            make the member available
	 */
	public QueuePauseAction(String iface, Boolean paused, String reason) {
		this.iface = iface;
		this.paused = paused;
		this.reason = reason;
	}
	 ...
	 *            make the member available
	 */
	public QueuePauseAction(String iface, String queue, Boolean paused, String reason) {
		this.iface = iface;
		this.queue = queue;
		this.paused = paused;
		this.reason = reason;
